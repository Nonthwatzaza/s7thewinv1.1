...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    const-string v8, "Dual_SIM Mobile networks !!"
    ...
    invoke-virtual {v7, v8, v10}, Landroid/app/AlertDialog$Builder;->setNeutralButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    .end local v4    # "simState2":Ljava/lang/String;
    ...
    .restart local v4    # "simState2":Ljava/lang/String;
    ...
    .line 253
    .local v0, "Sim2State":Ljava/lang/String;
    const-string v7, "0"
    ...
    const-string v8, "com.android.phone.NetworkSettingsTabActivity"
    ...
    const-string v8, "Check SIM2: Starts NetworkSettingsTabActivity"
    ...
    .line 279
    .end local v0    # "Sim2State":Ljava/lang/String;
    .end local v1    # "i":Landroid/content/Intent;
    .end local v3    # "simState":Ljava/lang/String;
    .end local v4    # "simState2":Ljava/lang/String;
    .end local v5    # "telephonyManager":Landroid/telephony/TelephonyManager;
    :cond_2
    iget-object v7, p0, Lcom/android/settings/WirelessSettings;->mAirplaneModePreference:Landroid/preference/CheckBoxPreference;
    ...
    invoke-virtual {p0, v7, v6}, Lcom/android/settings/WirelessSettings;->startActivityForResult(Landroid/content/Intent;I)V

    goto :goto_0

    .line 314
    :cond_3
    iget-object v7, p0, Lcom/android/settings/WirelessSettings;->mButtonSmartNetworkEnabled:Lcom/android/settings/SmartNetworkPreference;
    ...
    invoke-virtual {v7, v8}, Lcom/android/settings/SmartNetworkPreference;->checkSmartNetwork(Landroid/content/Context;)V
